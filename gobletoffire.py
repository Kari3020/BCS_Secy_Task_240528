...
class MazeVisualizer:
    ...
    def draw(self):
        self.screen.fill((30, 30, 30))  # Background: Very Dark Gray
        ...
        for y, row in enumerate(self.env.grid):
            for x, cell in enumerate(row):
                ...
                if cell == '#':
                    pygame.draw.rect(self.screen, (50, 50, 50), rect)  # Walls: Dark Gray

        pygame.draw.circle(self.screen, (0, 255, 0),   # Harry: Bright Green
                          (int((self.env.harry_pos[0]+0.5)*self.cell_size),
                           int((self.env.harry_pos[1]+0.5)*self.cell_size)),
                          int(self.cell_size/3))

        pygame.draw.circle(self.screen, (255, 0, 0),   # Death Eater: Bright Red
                          (int((self.env.death_eater_pos[0]+0.5)*self.cell_size),
                           int((self.env.death_eater_pos[1]+0.5)*self.cell_size)),
                          int(self.cell_size/3))

        pygame.draw.rect(self.screen, (255, 255, 0),  # Cup: Bright Yellow
